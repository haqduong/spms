...
<div id="wrap_main">
	...
	<div class="images">
		<img src="../images/public/mainh.jpg" width="100" height="150" /> <input
			name="duongdananh" type="text" placeholder="Chỗ này là đường dẫn ảnh" />
		<p>
		...
		<form name="edit_staff" action="#" method="POST">
			...
			<table border="0" bgcolor="#fff" align="center" id="info"
				...
				<tr>
					...
					<td class="list_ret" width="70%"><input id="name" type="text"
				...
				<tr>
					...
					<td class="list_ret"><select style="width: 392px;" id="hocvi"
						name="hocvi">
				...
				<tr>
					...
					<td class="list_ret"><select style="width: 392px;" id="chucvu"
						name="chucvu">
				...
				<tr>
					...
					<td class="list_ret"><select style="width: 392px;" id="hocham"
						name="hocham">
				...
				<tr>
					...
					<td class="list_ret"><select style="width: 392px;" id="capuy"
						name="capuy">
					...
					<td class="list_ret"><select style="width: 392px;"
						id="danhhieu" name="danhhieu">
							<c:forEach items="${danhhieu}" var="danhhieu">
								<c:if test="${canbo.danhhieu.iddanhhieu == danhhieu.iddanhhieu}">
					...
					<td class="list_ret"><select style="width: 392px;"
						id="xuatthan" name="xuatthan">
							<c:forEach items="${xuatthan}" var="xuatthan">
								<c:if test="${canbo.xuatthan.idxuatthan == xuatthan.idxuatthan}">
				...
				<tr>
					...
					<td class="list_ret"><input onkeyup="checkSHCC()" type="text"
						id="sohieucongchuc" name="sohieucongchuc" size="60" height="25"
						value="${canbo.sohieucongchuc}" />(*)</td>
				</tr>
				<tr>
					<td class="list">Số chứng minh nhân dân</td>
					<td class="list_ret"><input type="text" onkeyup="checkCMTND()"
						id="chungminhnhandan" name="chungminhnhandan" size="60"
						height="25" value="${canbo.chungminhnhandan}" />(*)</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="list_ret"><input type="tel" onkeyup="checkPhone()"
						name="sodienthoai" id="sodienthoai" size="60" height="25"
						value="${canbo.sodienthoai }" />(*)</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="list_ret"><select style="width: 392px;" id="dantoc"
						name="dantoc">
				...
				<tr>
					<td colspan="2" align="">
						...
						<center>
							...
							<INPUT type="button" value="Xóa sách" onclick="deleteRow('sach')" />
						</center>
					</td>
				</tr>
			</table>
