...
/**
 * Home object for domain model class Quocgia.
 * @see edu.hust.k54.persistence.Quocgia
 * @author Hibernate Tools
 */
public class QuocgiaHome {

	private static final Log log = LogFactory.getLog(QuocgiaHome.class);
	...
	public Quocgia findById(java.lang.Integer id) {
		...
		try {
			Quocgia instance = (Quocgia) sessionFactory.getCurrentSession()
					.get("edu.hust.k54.hibernate.Quocgia", id);
			if (instance == null) {
	...
	public List findByExample(Quocgia instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("edu.hust.k54.hibernate.Quocgia")
