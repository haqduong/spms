...
/**
 * Home object for domain model class Khenthuong.
 * @see edu.hust.k54.persistence.Khenthuong
		...
		try {
			Khenthuong instance = (Khenthuong) sessionFactory
					.getCurrentSession().get(
							"edu.hust.k54.hibernate.Khenthuong", id);
			if (instance == null) {
	...
	public List findByExample(Khenthuong instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("edu.hust.k54.hibernate.Khenthuong")
