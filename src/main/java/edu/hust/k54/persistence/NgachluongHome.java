...
/**
 * Home object for domain model class Ngachluong.
 * @see edu.hust.k54.persistence.Ngachluong
		...
		try {
			Ngachluong instance = (Ngachluong) sessionFactory
					.getCurrentSession().get(
							"edu.hust.k54.hibernate.Ngachluong", id);
			if (instance == null) {
	...
	public List findByExample(Ngachluong instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("edu.hust.k54.hibernate.Ngachluong")
